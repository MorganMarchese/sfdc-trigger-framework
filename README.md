# SFDC trigger framework (Experimental)
** This is an experimental fork of the Kevin O'Hara Trigger Framework. This should not be used in any production environments. Use at your own risk. Author/Modifiers take no responsibility for impact that this framework may have to your Salesforce Org.
